...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.current_res = QtWidgets.QTableView(self.groupBox)
        self.current_res.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.current_res.setObjectName("current_res")
        self.gridLayout_2.addWidget(self.current_res, 0, 0, 1, 1)
